...
export const CarInfoCard = () => {
  ...
  return (
    <div className="car_info">
      ...
      {data.length &&
        data.map((e, idx) => (
          <div className="car_info_box" key={idx}>
          ...
          /> */}
              <iframe
                width={824}
                height={444}
                src={`https://momento360.com/e/u/729ae0d612384dd0a8456dce2a257fd0? 
                        utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of- 
                        view=75&size=large&display-plan=true`}
                frameborder="0"
              ></iframe>
              <div className="car_info_right_bottom_before">
                ...
                <div className="car_info_right_bottom">
                  <NavLink
                    to={`/cartype/${e.id}`}
                    className="car_info_right_bottom"
                  >
                    <input
                      type="radio"
